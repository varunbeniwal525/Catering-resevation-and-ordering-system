                    ...
                    <!-- Form starts.  -->
                     <form class="form-horizontal" role="form" action="details_save.php" method="post">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-5">
                                    <input type="text" id="datepicker"  min="2023-01-01" max="2023-12-31" class="form-control" name="date" required>
                                ...
                                <div class="form-group">
                                  <label class="col-lg-2 control-label">Number of Products Per Type:</label>
                                  <div class="col-lg-5">
                                    <input type="number" min="10" max="50" class="form-control" placeholder="" name="pax">
                                  </div>
                                </div> 
                                <div class="form-group">
