			...
			<div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="widget-content">
                  <div class="padd" style="height:650px">
                    ...
                    <h3 style="text-align:center">Brew Pod Coffee Station</h3>
                    <h4 style="text-align:center">044, National Highway Brgy. San Jose, Castillejos</h4>
                    <h4 style="text-align:center">Mol. No. : 0929 305 5685</h4>
                    <h4 style="text-align:center">Email : brewpodcoffeestation@gmail.com</h4>
                    <h4 style="text-align:center">Facebook : https://www.facebook.com/BrewPodCoffeeStation</h4>
                    <h4 style="text-align:center">Instagram : https://www.instagram.com/brewpodcoffeestation</h4>
                    <hr>
...
?>                      
                      ...
                      <tr>  
                        <td></td>
                        <td></td>
                        <td>Number of Products Per Type </td>
...
<div style="width:50%;float:left">
  ...
  <span>No. of products per item <?php echo $row['pax'];?> * <?php echo $row['price'];?> = <?php echo $row['payable'];?></span>
  <ul>
