                    ...
                    <!-- Form starts.  -->
                     <form class="form-horizontal" role="form" action="reservation_save.php" method="post">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-5">
                                    <input type="text" maxlength="11" pattern="\d{11}" title="Please enter exactly 11 digits" placeholder="Contact #" name="contact" required>
                                  </div>
                                </div>
								 ...
								 <div class="form-group">
                                  ...
                                  <div class="col-lg-5">
                                    <label class="checkbox-inline">
                                      <input type="checkbox" id="inlineCheckbox1" value="option1" required> I agree to the <a href="#facilities" data-toggle="modal">terms and condtion</a> of Brew Pod Coffee Station
                                    </label>
									</div>
									</div>
